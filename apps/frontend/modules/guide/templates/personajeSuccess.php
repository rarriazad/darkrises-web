...
<div style="margin-top:10px;">
        ...
        <p style="text-align:center;"><img src="../../images/tienda.jpg" /></p>
     ...
     <p><span style="color:#F60"><strong>Armario:</strong></span> Sitio donde quedan almacenados los items comprados en la tienda, obtenidas en mision o en batalla. Desde esta sección también se pueden regalar y vender los objetos.</p>
        ...
        <p style="text-align:center;"><img src="../../images/armario.jpg" /></p>
    ...
    <div style="margin-top:10px;">
        ...
        <p style="text-align:center;"><img src="../../images/caracteristicas.jpg" /></p>
        ...
        <p style="text-align:center;"><img src="../../images/ppoderes.jpg" /></p>
        
        <p><span style="color:#F60"><strong>Maletero:</strong></span> Lugar donde puedes guardar objetos a modo de baúl.</p>
        <p style="text-align:center;"><img src="../../images/maletero.jpg" /></p>
        ...
        <p style="text-align:center;"><img src="../../images/bunker.jpg" /></p>
        ...
        <p style="text-align:center;"><img src="../../images/inventario.jpg" /></p>
    </div>
    <div style="margin-top:50px;">                
    ...
    <div style="margin-top:10px;">
        ...
        <p style="text-align:center;"><img src="../../images/crecimiento.jpg" /></p>
        ...
        <p style="text-align:center;"><img src="../../images/puntosdealma.jpg" /></p>
        ...
        <p><span style="color:#F60; font-size:18px;"><strong><img src="../../images/a.png" />Ángeles</strong></span></p>
...
<p>En niveles avanzados los Ángeles pueden desarrollar sus poderes enfocando su afinidad por el poderoso elemento <strong>Trueno</strong>, mientras que otros optan por la versatilidad y lo etéreo de las <strong>Ráfagas</strong>.</p>
        ...
        <div style="width:151px; float:left; margin-right:10px;"><img src="../../images/angfuerza.jpg" /></div>
...
        Son la fuerza de aniquilación de los  ángeles, incluso para sus aliados es peligroso estar muy cerca de ellos en un  campo de batalla, ya que pueden ser destruidos cuando estos despliegan su poder.</p>
      ...
      <div style="clear:both;"></div>
        ...
        <span style="color:#F60"><strong>Ángeles tipo Inteligencia:</strong></span>
         <div style="margin-top:10px; margin-bottom:10px;">
        <div style="width:151px; float:left; margin-right:10px;"><img src="../../images/anginteligencia.jpg" /></div>
      ...
      <div style="clear:both;"></div>
        ...
        <p><span style="color:#F60; font-size:18px;"><strong><img src="../../images/h.png" />Humanos</strong></span></p>
        ...
        <div style="margin-top:10px; margin-bottom:10px;">
        <div style="width:151px; float:left; margin-right:10px;"><img src="../../images/humfuerza.jpg" /></div>
      <div style="width:639px; float:left;">
      ...
      <div style="clear:both;"></div>
        ...
        <div style="margin-top:10px; margin-bottom:10px;">
        <div style="width:151px; float:left; margin-right:10px;"><img src="../../images/humdestreza.jpg" /></div>
      <div style="width:639px; float:left;">
      ...
      <p><span style="color:#F60; font-size:18px;"><strong><img src="../../images/d.png" />Demonios</strong></span></p>
      ...
      <p>En niveles avanzados los Demonios pueden desarrollar sus poderes enfocando su afinidad por el destructivo elemento<strong> Fuego</strong>, mientras que otros optan por lo mortal y lo frío del <strong>Hielo</strong>.</p>
        ...
        <span style="color:#F60"><strong>Demonios tipo Fuerza:</strong></span>
            <div style="margin-top:10px; margin-bottom:10px;">
        <div style="width:151px; float:left; margin-right:10px;"><img src="../../images/demfuerza.jpg" /></div>
      <div style="width:639px; float:left;">
      ...
      <div style="clear:both;"></div>
        ...
        <div style="margin-top:10px; margin-bottom:10px;">
        <div style="width:151px; float:left; margin-right:10px;"><img src="../../images/deminteligencia.jpg" /></div>
      <div style="width:639px; float:left;">
      ...
      <div style="clear:both;"></div>
        ...
        <!-- InstanceBeginEditable name="bot" --><div style="background-image:url(../../images/bot.png); background-repeat:no-repeat; height:28px;"></div>
        <!-- InstanceEndEditable -->
    </div>
    <div id="pie">
