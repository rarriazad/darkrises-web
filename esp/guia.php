...
<div id="contenedor">
    ...
    <div style="margin-top:20px;">
        ...
        <p style="text-align:center;"><img src="../img/interfaz.jpg" /></p>
  ...
  <tr>
    <td><span style="text-align:center;"><img src="../img/h.png" /></span></td>
    <td><span style="text-align:center;"><img src="../img/d.png" /></span></td>
    <td><span style="text-align:center;"><img src="../img/a.png" /></span></td>
  </tr>
  <tr>
...
<p><span style="color:#F60"><strong>1- Nombre:</strong></span> Muestra el nombre que se eligió para el personaje en el comienzo.</p>
        ...
        <p><span style="color:#F60"><strong>6- Dinero:</strong></span> <img src="../img/m.png" /> Cantidad de dinero virtual.</p>
        <p><span style="color:#F60"><strong>7- Drak:</strong></span> <img src="../img/drak.png" />Cantidad de dinero real que posee el personaje.</p>
        <p><span style="color:#F60"><strong>8- Itemshop:</strong></span> Tienda en la cual se pueden comprar objetos con Drak</p>
        <p><span style="color:#F60"><strong>9- Ayuda:</strong></span> <img src="../img/help.png" />Muestra el tutorial de la sección en la que se encuentra el personaje.</p>
    ...
    <div style="margin-top:10px;">
        ...
        <p style="text-align:center;"><img src="../img/mensajes.jpg" /></p>
        ...
        <p style="text-align:center;"><img src="../img/actualizaciones.jpg" /></p>
...
<div style="margin-top:50px;">                
    ...
    <div style="margin-top:10px;">
        ...
        <p style="text-align:center;"><img src="../img/historias.jpg" /></p>
    </div>                   
